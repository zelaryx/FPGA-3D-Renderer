...
HD_PWD='C:/Users/shivg/Desktop/ece385/final_project/final_project.runs/block_design_microblaze_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block_design_microblaze_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source block_design_microblaze_0_1.tcl
