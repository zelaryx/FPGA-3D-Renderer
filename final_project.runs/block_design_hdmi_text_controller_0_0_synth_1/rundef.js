...
ISEStep( "vivado",
         "-log block_design_hdmi_text_controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source block_design_hdmi_text_controller_0_0.tcl" );
