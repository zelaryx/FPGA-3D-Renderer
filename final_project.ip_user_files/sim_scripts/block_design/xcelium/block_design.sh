...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../final_project.gen/sources_1/bd/block_design/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../final_project.gen/sources_1/bd/block_design/ip/block_design_hdmi_text_controller_0_0/src/clk_wiz_0" \
       +incdir+"../../../../final_project.gen/sources_1/bd/block_design/ipshared/ec67/hdl" \
       +incdir+"../../../../final_project.gen/sources_1/bd/block_design/ip/block_design_hdmi_text_controller_0_0/src/clk_wiz_0" \
       -input simulate.do
}
