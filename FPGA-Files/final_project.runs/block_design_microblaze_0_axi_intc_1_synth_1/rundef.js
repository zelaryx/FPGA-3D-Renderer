...
ISEStep( "vivado",
         "-log block_design_microblaze_0_axi_intc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source block_design_microblaze_0_axi_intc_1.tcl" );
